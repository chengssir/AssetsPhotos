...
@interface TNCAlbumViewController ()<UITableViewDataSource,UITableViewDelegate>
@property (nonatomic, strong) UITableView       *tableView;
@property (nonatomic, copy) NSArray *assetsGroups;

@end

@implementation TNCAlbumViewController
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    if (self.imagePickerController.isFrist) {
        ...
        TNCAssetsViewController *controller = [[TNCAssetsViewController alloc] init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    TNNImagePickerGroupCell *cell=[tableView dequeueReusableCellWithIdentifier:indetify];
    if (cell==nil) {
        cell=[[TNNImagePickerGroupCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:indetify];
    }
...
{
    TNCAssetsViewController *assetsViewController = [[TNCAssetsViewController alloc]init];
